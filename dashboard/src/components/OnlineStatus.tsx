...
export const OnlineStatus: FC<UserStatusProps> = ({lastOnline}) => {
    ...
    const dateInfo = unixTime ? relativeExpiryDate(unixTime) : {status: "", time: t("onlineStatus.notConnectedYet", "Not Connected Yet")};
        ...
        >
            {timeDifferenceInSeconds && timeDifferenceInSeconds <= 60
                ...
                : timeDifferenceInSeconds && dateInfo.time
                    ? (
                        <>
                            <Box as="span" dir="ltr" display="inline-block" style={{ unicodeBidi: "embed" }}>
                                {dateInfo.time}
                            </Box>
